...
- As 0xdf notes in [their writeup](https://0xdf.gitlab.io/2019/09/07/htb-bastion.html): regarding the SAM registry files, they are usually locked away when the system is live, but on a mounted drive you can view them.
